defmodule TestApp.Charon.CompiledJwt do
  @moduledoc false
...
defmodule TestApp.Charon.CompiledJwt.Sha256 do
  @moduledoc false
  ...
  use Charon.TokenFactory.CompiledJwt, config: @config, signing_alg: :hmac_sha256

  def config(), do: @config
end

defmodule TestApp.Charon.CompiledJwt.Ed25519 do
  @moduledoc false
  @config Charon.Config.from_enum(
            token_issuer: "my_test_app",
            get_base_secret: &TestApp.Charon.CompiledJwt.get_base_secret/0,
  ...
  use Charon.TokenFactory.CompiledJwt, config: @config, signing_alg: :eddsa_ed25519

  def config(), do: @config
end

defmodule TestApp.Charon.CompiledJwt.Poly1305 do
  @moduledoc false
